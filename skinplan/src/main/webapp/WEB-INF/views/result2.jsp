...
<body class=" bg-info bg-opacity-25">
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./resources/img1/img1.jpg" class="d-block w-100" height=300px alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./resources/img1/img2.jpg" class="d-block w-100" height=300px alt="...">
                 </div>
                <div class="carousel-item">
                    <img src="./resources/img1/img3.jpg" class="d-block w-100" height=300px alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./resources/img1/img4.jpg" class="d-block w-100" height=300px alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./resources/img1/img5.jpg" class="d-block w-100" height=300px alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./resources/img1/img6.jpg" class="d-block w-100" height=300px alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./resources/img1/img7.jpg" class="d-block w-100" height=300px alt="...">
                </div>
            </div>
    ...
    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-body">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th scope="row">회사</th>
                                        <td colspan="3">삼성메디코스(주) / (주)비나우</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">성분</th>
                                        <td class="fw-bolder" colspan="3">비피다발효용해물(42%),갈락토미세스발효여과물(21%),부틸렌글라이콜</td>
                                      </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="my-5">
            <a href="main_log.html" class="w-100 btn btn-primary btn-lg">돌아가기</a>
        </div>
    </div>
